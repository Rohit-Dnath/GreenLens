...
const TransitPanel = ({ location, visible, transitData }) => {
  ...
  return (
    <Paper
      ...
      sx={{
        position: "absolute",
bottom: 20, // Anchored to the bottom-left corner
left: 20,
width: 350,
maxWidth: "90vw",
maxHeight: "80vh",
zIndex: 1000,
background: "linear-gradient(135deg, rgba(34, 193, 195, 0.95), rgba(253, 187, 45, 0.95))", // Vibrant green-tech gradient
backdropFilter: "blur(8px)", // Glassmorphism effect
borderRadius: "16px", // Smooth rounded corners for a modern look
boxShadow: "0 8px 24px rgba(0, 0, 0, 0.2)", // Depth with subtle shadow
padding: "16px", // Adds consistent spacing inside the box
overflow: "hidden",
display: "flex",
flexDirection: "column",
border: "1px solid rgba(255, 255, 255, 0.3)", // Semi-transparent border
transition: "transform 0.3s ease, box-shadow 0.3s ease", // Smooth animations for interactions

":focus-within": {
  outline: "2px solid rgba(253, 187, 45, 0.5)", // Highlighted outline for focus
  boxShadow: "0 10px 30px rgba(253, 187, 45, 0.4)", // Glow effect on focus
},
color: "#ffffff", // White text for readability
fontWeight: "bold", // Clean and modern typography
