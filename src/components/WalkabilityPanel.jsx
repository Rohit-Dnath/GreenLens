...
":focus-within": {
  outline: "2px solid rgba(253, 187, 45, 0.5)", // Focus outline for accessibility
  boxShadow: "0 10px 30px rgba(253, 187, 45, 0.3)", // Glowing effect when focused
},
color: "#ffffff", // White text for readability
fontWeight: "bold", // Modern typography
fontSize: "14px", // Clean and standard text size
          ...
          <Grid item xs={12}>
            <Paper
              sx={{
                ...
                border: `2px solid ${getScoreColor(stats.walkabilityScore)}`,
              }}
            >
